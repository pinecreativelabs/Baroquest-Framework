...
if (iOSChromeDetected) {
  ...
  const elements = Array.from(document.getElementsByClassName('twist'));
...
(function() {
  ...
  var rafActive = false
  // Container element
  var container = document.querySelector('.writhen-scroll')
  // Array with `.box` elements
  var images = Array.prototype.slice.call(document.querySelectorAll('.box'))
